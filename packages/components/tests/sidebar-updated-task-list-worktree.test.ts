...
import { SidebarUpdatedTaskList } from '../src/components/sidebar-updated-task-list';
import { initI18n } from '../src/i18n';

describe('SidebarUpdatedTaskList session-type icon', () => {
  ...
  it('does not render a session-type icon in the row (it lives in the hover card now)', () => {
    ...
    flushSync(() => {
      root?.render(
        React.createElement(SidebarUpdatedTaskList, {
