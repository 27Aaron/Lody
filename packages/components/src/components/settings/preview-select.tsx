    ...
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        <button
          ...
          type="button"
          className={cn(
            'flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input-border bg-input px-3 py-2 text-sm text-input-foreground shadow-xs ring-offset-background focus:outline-hidden focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50',
            triggerClassName
          )}
        >
